(function ($) {
  ...
  var RSS = function (target, url, options, callback) {
    ...
    this.options = $.extend({
      ...
      entryTemplate: '<a href="{url}"><li><h1><span class="sm-col-1"><i class="pointStyle fa fa-chevron-right"></i> {title}</h1><h3><small><i class="fa fa-calendar"></i> {date} <br> {author}</small> </h3><p class="capitalize">{shortBodyPlain}</p></li></a>',
      tokens: {},
      outputMode: 'json',
